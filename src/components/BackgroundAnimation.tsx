...
const BackgroundAnimation: React.FC = () => {
  ...
  useEffect(() => {
    ...
    logo.src = 'https://waiting-wrist-6f6.notion.site/image/attachment%3Aece6d6ed-e2f5-4f53-9fb8-8050950c0efa%3AVulti_Agent_Mobile.png?table=block&id=19123043-5592-8041-9a9e-e83d7765263e&spaceId=59ea08d2-bc07-4c80-b51a-dbd605835b75&width=380&userId=&cache=v2';
